...
<!-- TODO: 프로젝트 대표 이미지 (카트 + 마트 맵 + 로봇 주행 사진) -->
...
**AMR(Autonomous Mobile Robot) 기반 자율주행 쇼핑카트** 시스템을 구현하는 것을 목표로 한다.
...
→ **오프라인 매장의 재부상**과 함께, 효율적인 운영 및 고객 경험 개선이 중요한 과제가 됨.
...
## 10. AI·Computer Vision 기술

### 10.1 AI in Mart – 요구사항
...
### 11.2 Path Planning (Nav2 – SmacPlanner2D & RPP)
...
> 이 README는 위 역할 분담을 기반으로,  
> 각 모듈 및 기능 구현 내용을 기술 중심으로 재구성하였다.
